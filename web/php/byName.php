...
$query = "SELECT OBJECT_tb.gid,OBJECT_tb.name,OBJECT_tb.alternative,OBJECT_tb.source_Author,OBJECT_tb.CFM_version,OBJECT_tb.model_description,OBJECT_tb.descriptor,OBJECT_tb.strike,OBJECT_tb.dip,OBJECT_tb.area,OBJECT_tb.exposure,OBJECT_tb.final_slip_sense,OBJECT_tb.reference,OBJECT_tb.reference_check,OBJECT_tb.ID_comments,OBJECT_tb.USGS_ID,FAULT_tb.name from OBJECT_tb,FAULT_tb where FAULT_tb.abb=$1 and FAULT_tb.gid=OBJECT_tb.FAULT_tb_gid";
...
echo "<div data-side=\"metaByName\" data-params=\"";
echo $metastring;
